...
public class CreatePolicySteps {
    ...
    @Then("^I receive a response from DSM that contains the expected policy$")
    public void i_receive_a_response_from_DSM_that_contains_the_expected_policy() throws Throwable {
    }
}
